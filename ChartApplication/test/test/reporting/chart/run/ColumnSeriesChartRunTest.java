 ...
 * @author merrill.paul
 */
public class ColumnSeriesChartRunTest {
    ...
    public ColumnSeriesChartRunTest() {
    }
    ...
    public static void setUpClass() throws Exception {
        ...
        cfg.setDescription("MS COLUMN CHART1");
        cfg.setHeight(400);
        cfg.setWidth(500);
        ...
        try {
            ...
            Logger.getLogger(ColumnSeriesChartRunTest.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        cfg.setChartTypeAsEnum(ChartType.MULTI_SERIES_COLUMN);
        cfg.setDescription("BAR SIMPLE CHART1");
        cfg.setHeight(400);
        cfg.setWidth(500);
        cfg.setXAxisLabel("Date");
        cfg.setYAxisLabel("Population");
       ...
       /////////////// SECOND SIMPLE CHART
        ...
        cfg.setChartTypeAsEnum(ChartType.MULTI_SERIES_COLUMN);
        cfg.setDescription("MS BAR TUPLE CHART");
        cfg.setHeight(400);
        cfg.setWidth(500);
        cfg.setXAxisLabel("Date");
        cfg.setYAxisLabel("Population");
 ...
 cfg.setChartQuery("SELECT   to_char(the_date,'dd-Mon-yyyy hh24:mi:ss') ,'DRILLDOWN' \"DRILLDOWN\", 'Males' \"seriesName1\", 'Females' \"seriesName2\", 'Eunuchs' \"seriesName3\", male_value \"seriesValue1\", female_value \"seriesValue2\" , (male_value+female_value) \"seriesValue3\" from bar_live_demo where to_date(to_char(the_date,'dd-Mon-yyyy'),'dd-Mon-yyyy')= to_date('26-May-2010','dd-Mon-yyyy')");
        cfg.setChartTypeAsEnum(ChartType.MULTI_SERIES_COLUMN);
        cfg.setDescription("BAR DRILL DOWN COLUMN CHART1");
        cfg.setHeight(400);
        cfg.setWidth(500);
        cfg.setXAxisLabel("Date");
        cfg.setYAxisLabel("Population");
 ...
 cfg.setChartQuery("SELECT   to_char(the_date,'dd-Mon-yyyy hh24:mi:ss') ,male_value \"seriesValue\",'DRILLDOWN' \"DRILLDOWN\", 'Males' \"seriesName\" from bar_live_demo where to_date(to_char(the_date,'dd-Mon-yyyy'),'dd-Mon-yyyy')= to_date('26-May-2010','dd-Mon-yyyy')");
        cfg.setChartTypeAsEnum(ChartType.MULTI_SERIES_COLUMN);
        cfg.setDescription("BAR DRILL DOWN  SINGLE SERIES COLUMN CHART1");
        cfg.setHeight(400);
        cfg.setWidth(500);
        cfg.setXAxisLabel("Date");
        cfg.setYAxisLabel("Population");
        cfg.setName("MS DRILL DOWN  SINGLE SERIES COLUMN CHART1");
        cfg.setShowLegend(true);
        cfg.setShowTitle(true);
