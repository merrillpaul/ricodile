...
import com.flytxt.commons.chart.fusion.api.msarea.Set;
import com.flytxt.commons.chart.fusion.api.msarea.Dataset;
import com.flytxt.commons.chart.fusion.api.msarea.MSArea;
import com.flytxt.commons.chart.fusion.api.msarea.Categories;
 ...
 */
public class FusionMultiSeriesAreaChartGenerator extends AbstractFusionChartGenerator {

    public FusionMultiSeriesAreaChartGenerator () {
    }

    public void prepareFusionChart (ChartOutput chartoutput, DataSet dataset) {

        MultiseriesAreaDataSet  _dataSet =    (MultiseriesAreaDataSet)dataset;
