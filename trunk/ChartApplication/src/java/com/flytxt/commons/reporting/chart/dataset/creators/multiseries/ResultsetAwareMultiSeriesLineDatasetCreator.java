...
import com.flytxt.commons.reporting.chart.dataset.base.multiseries.line.MultiSeriesDataSet;
...
public class ResultsetAwareMultiSeriesLineDatasetCreator
        extends MultiSeriesLineDatasetCreator implements JDBCResultsetAwareCreator {
    private ChartResultSetPreparer resultSetPreparer;

    public ResultsetAwareMultiSeriesLineDatasetCreator () {
    }
   ...
   /**
    ...
    public void prepareDataset() throws ChartException {
       try {
            MultiseriesLineDataSet dataSet = this.getDataSet();
            ...
            Logger.getLogger(ResultsetAwareMultiSeriesLineDatasetCreator.class.getName()).log(Level.SEVERE, null, ex);
