 ...
 */
public class LineResultSetChart {

      private Long chartId;
       private static ParameterMasterService service;

    public LineResultSetChart() {
    }
    ...
    public void setUp() {
        ...
        cfg.setChartTypeAsEnum(ChartType.LINE);
        cfg.setDescription("Status Id Pie Stupid Chart");
        cfg.setHeight(400);
        cfg.setWidth(500);
        cfg.setName("VishnuLineTest");
        ...
        ChartConfigService service = null;
            try {
                ...
                Logger.getLogger(LineResultSetChart.class.getName()).log(Level.SEVERE, null, ex);
            }
