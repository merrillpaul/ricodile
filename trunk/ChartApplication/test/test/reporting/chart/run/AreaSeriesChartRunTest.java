 ...
 * @author merrill.paul
 */
public class AreaSeriesChartRunTest {
    ...
    public static void setUpClass() throws Exception {
        ...
        cfg.setChartTypeAsEnum(ChartType.MULTI_SERIES_AREA);
        cfg.setDescription("MS AREA CHART1");
        cfg.setHeight(400);
        cfg.setWidth(500);
        cfg.setXAxisLabel("Date");
        cfg.setYAxisLabel("Population");
        cfg.setName("MS AREA CHART1");
        ...
        try {
            ...
            Logger.getLogger(AreaSeriesChartRunTest.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        cfg.setChartTypeAsEnum(ChartType.MULTI_SERIES_AREA);
        cfg.setDescription("AREA SIMPLE CHART1");
        cfg.setHeight(400);
        cfg.setWidth(500);
        cfg.setXAxisLabel("Date");
        cfg.setYAxisLabel("Population");
        cfg.setName("BAR SIMPLE CHART1");
        cfg.setShowLegend(true);
        cfg.setShowTitle(true);
       ...
       /////////////// SECOND SIMPLE CHART
        ...
        cfg.setChartTypeAsEnum(ChartType.MULTI_SERIES_AREA);
        cfg.setDescription("MS AREA TUPLE CHART");
        cfg.setHeight(400);
        cfg.setWidth(500);
        cfg.setXAxisLabel("Date");
        cfg.setYAxisLabel("Population");
        cfg.setName("MS BAR TUPLE CHART");
        cfg.setShowLegend(true);
        cfg.setShowTitle(true);
 ...
 cfg.setChartQuery("SELECT   to_char(the_date,'dd-Mon-yyyy hh24:mi:ss') ,'DRILLDOWN' \"DRILLDOWN\", 'Males' \"seriesName1\", 'Females' \"seriesName2\", 'Eunuchs' \"seriesName3\", male_value \"seriesValue1\", female_value \"seriesValue2\" , (male_value+female_value) \"seriesValue3\" from bar_live_demo where to_date(to_char(the_date,'dd-Mon-yyyy'),'dd-Mon-yyyy')= to_date('26-May-2010','dd-Mon-yyyy')");
        cfg.setChartTypeAsEnum(ChartType.MULTI_SERIES_AREA);
        cfg.setDescription("MS AREA DRILL DOWN COLUMN CHART1");
        cfg.setHeight(400);
        cfg.setWidth(500);
        cfg.setXAxisLabel("Date");
        cfg.setYAxisLabel("Population");
        cfg.setName("MS DRILL DOWN COLUMN CHART1");
        cfg.setShowLegend(true);
        cfg.setShowTitle(true);
 ...
 cfg.setChartQuery("SELECT   to_char(the_date,'dd-Mon-yyyy hh24:mi:ss') ,male_value \"seriesValue\",'DRILLDOWN' \"DRILLDOWN\", 'Males' \"seriesName\" from bar_live_demo where to_date(to_char(the_date,'dd-Mon-yyyy'),'dd-Mon-yyyy')= to_date('26-May-2010','dd-Mon-yyyy')");
        cfg.setChartTypeAsEnum(ChartType.MULTI_SERIES_AREA);
        cfg.setDescription("MS AREA DRILL DOWN  SINGLE SERIES COLUMN CHART1");
        cfg.setHeight(400);
        cfg.setWidth(500);
        cfg.setXAxisLabel("Date");
        cfg.setYAxisLabel("Population");
        cfg.setName("MS AREA DOWN  SINGLE SERIES COLUMN CHART1");
        cfg.setShowLegend(true);
        cfg.setShowTitle(true);
