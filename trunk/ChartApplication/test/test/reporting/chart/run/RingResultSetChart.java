 ...
 */
public class RingResultSetChart {

      private Long chartId;
       private static ParameterMasterService service;

    public RingResultSetChart() {
    }
    ...
    public void setUp() {
        ...
        cfg.setChartTypeAsEnum(ChartType.RING);
        cfg.setDescription("Status Id Pie Stupid Chart");
        cfg.setHeight(400);
        cfg.setWidth(500);
        cfg.setName("Ring Chart"+new RandomStringGenerator().getRandomString(3));
        ...
        ChartConfigService service = null;
            try {
                ...
                Logger.getLogger(RingResultSetChart.class.getName()).log(Level.SEVERE, null, ex);
            }
