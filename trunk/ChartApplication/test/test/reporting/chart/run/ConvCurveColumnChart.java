...
public class ConvCurveColumnChart {
    ...
    public void setUp() {
        ...
        cfg.setName("Conv Curve COLUMN"+new RandomStringGenerator().getRandomString(3));
    ...
    //
    @Test
    public void testConversionCurveColumnChart() {
